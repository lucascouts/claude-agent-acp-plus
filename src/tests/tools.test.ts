...
// ACP tool-call-name RFD (#1128): the initial tool_call carries the programmatic
...
describe("standard `name` on tool_call notifications", () => {
  ...
  // Omission means "unchanged" on a v1 update, and the tool behind a
  // toolCallId never changes — so only the first report carries it.
